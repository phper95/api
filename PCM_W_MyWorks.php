<?php
/**
* @api {post} /gmspanel/interface/zh-cn/3.1/PCM_W_MyWorks.php 获取我的"未完成作品","已上线作品","被收录作品"和"被下线作品"
* @apiPermission pxseven
* @apiVersion 0.1.0
* @apiName MyWorks
* @apiGroup Work
* @apiSampleRequest http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_MyWorks.php
