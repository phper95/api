<?php
/**
* @api {post} /gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithNew1.php 新建一部原创作品（内部接口）
* @apiPermission pxseven
* @apiVersion 0.1.0
* @apiName CreatWithNew1
* @apiGroup Work
* @apiSampleRequest http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithNew1.php
