<?php
/**
* @api {post} /gmspanel/interface/zh-cn/3.1/PCM_W_SetUpUpload.php 准备上传
* @apiPermission pxseven
* @apiVersion 0.1.0
* @apiName SetUpUpload
* @apiGroup Work
* @apiSampleRequest http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_SetUpUpload.php
	...
	if($need_creat_new_workkey){
		...
		if(strlen($post_dburl)){
			...
			*/
			...
			$response_json = request_by_curl('http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithDb.php',$post_string);
		...
		if($is_newwork){
			...
			*/
			...
			$response_json = request_by_curl('http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithNew.php',$post_string);
