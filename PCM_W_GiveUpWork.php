<?php
/**
* @api {post} /gmspanel/interface/zh-cn/3.1/PCM_W_GiveUpWork.php 放弃作品创作
* @apiPermission pxseven
* @apiVersion 0.1.0
* @apiName GiveUpWork
* @apiGroup Work
* @apiSampleRequest http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_GiveUpWork.php

* @apiDescription 用户关联作品后，发现已有很多人在图解这部影片，点击了取消按钮，放弃创作时请求此接口取消占坑
...
* @apiError WorkCantModify 该作品已上线无法取消
