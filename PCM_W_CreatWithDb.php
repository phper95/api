<?php
/**
* @api {post} /gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithDb.php 通过豆瓣URL新建一部作品
* @apiPermission pxseven
* @apiVersion 0.1.0
* @apiName CreatWithDb
* @apiGroup Work
* @apiSampleRequest http://ser3.graphmovie.com/gmspanel/interface/zh-cn/3.1/PCM_W_CreatWithDb.php
...
*/
	...
	//电影ID的格式:http://movie.douban.com/subject/20326665/?from=showing
