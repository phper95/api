require.config({
    paths: {
        ...
        diffMatchPatch: './public/js/diff_match_patch.min',
        handlebars: './public/js/handlebars.min',
        handlebarsExtended: './public/js/handlebars_helper',
        jquery: './public/js/jquery.min',
        locales: './locales/locale',
        lodash: './public/js/lodash.min',
        pathToRegexp: './public/js/path-to-regexp/index',
        prettify: './public/js/prettify/prettify',
        utilsSampleRequest: './public/js/send_sample_request',
    },
    shim: {
        bootstrap: {
            deps: ['jquery']
